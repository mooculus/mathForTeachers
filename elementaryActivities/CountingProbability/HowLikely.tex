...
\begin{problem}
Remember the Amazing Race, where you travel from home to New York by car, train, bus, or plane, then travel to London by ship or plane, and finally to Paris by ship, plane or helicopter? Assume that you choose each leg of your journey randomly. Let's calculate some probabilities related to these journeys. In each case, explain your thinking to your group.
\begin{enumerate}
