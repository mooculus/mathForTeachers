...
\begin{problem}
 Free-Lance Freddy works a different job each day.  At each job, he earns an hourly rate that depends on the
...
money they currently owe (with his lunch money added in).  On Monday, 3 hours into his work as a gourmet burger flipper,
  Freddy's meter reads $\$42$. Then, 7 hours into his work, his meter reads
  $\$86$. 
  
  \begin{enumerate}
  \item  If he works for 9 hours, how much money will he have?  
  \item When will he have $\$75$?
  \end{enumerate}
  \vskip 3in
...
\begin{problem}
We've now studied three different situations: Freddy, Sam, and Gertrude (the Gumchewer). How are they alike?  How are they different?  Did you solve them in the same way?  Why or why not?
\end{problem}

\vfill

\begin{problem}
What might we mean if we say that a sequence has a "constant rate of change"? Does Freddy, Sam, or Gertrude have one? How can you tell? Consider your reasoning, your table, and your equation.
\end{problem}
 \vfill


\begin{problem} 
Challenge problem! Let's generalize our work on Freddy and Sam's problems.
\begin{enumerate}
    \item Suppose that Free Lance Freddy's meter shows that he has earned $\$D $ after working for $H$ hours, and his meter shows $\$E$ after working for $K $ hours. How much money, $y$, will his meter show he has earned after working for a total of $x$ hours?
    \item Suppose that Slimy Sam's car can only go a maximum of S miles per hour all the way from where he stole the car (just now at the Rest Area $P$ miles west of the Indiana line) and goes as far as he can before running out of gas T hours from now. Where will he be $x$ hours after stealing the car?
