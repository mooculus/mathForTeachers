...
Finally, we can connect Gertrude back to our sequences activity by asking what type of sequence we are seeing with Gertrude. While we can introduce the terminology for arithmetic sequences in any of the three activities (Sequences, Gertrude, Walk the Line), it's great to have students practice stating the pattern of the sequence in their own words.
