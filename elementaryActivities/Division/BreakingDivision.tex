...
\begin{itemize}
	...
	\item These solutions by story problem are difficult to distinguish. We will rely more heavily on the algebra to clearly distinguish the types. Students should be able to use one of the two methods (either story or algebra) to discuss the main ideas, but we won't ask them for both.
