...
\begin{itemize}
	...
	\item Students may give mixed-number answers rather than improper fractions for the quotient (if appropriate to the question) since they are counting full groups as well as partial groups. This should be presented in problem 4, and if no one in the class finds the improper fraction answer then that is a good opportunity for the instructor to add to the discussion.
