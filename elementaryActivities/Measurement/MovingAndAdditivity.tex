...
\item Here are some common solution methods you might see or elicit.
\begin{itemize}
...
Problems 2 and 3:
\begin{itemize}
\item These are more challenging, but fun!   Students may also assume any symmetry that seems obvious, especially as they think about folding parts of the outer rectangle or shaded shape to match with other parts of the figure. Note that the Pythagorean theorem and area of a triangle formulas are not permitted on this problem because they have not yet been justified in class. Students should focus on rearranging the pieces of area in creative ways. The area should be 16 square units for problem 2 and 36 square units for problem 3. 
\item For both problems, there's a nice strategy here of dividing the whole into equal-sized pieces and then using fraction thinking to see what fraction of the whole is shaded.
\end{itemize}
