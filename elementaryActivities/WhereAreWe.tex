...
%\begin{problem}
%Now let's go back to the floor and assume you're not a member of the ``club" of points described in number 4a.  To what point would you go if you reflected across that line?  Do the same for those in number 4b and number 4e. Describe as complicated a set of points as you can that, if they are all reflected about those sets of points, the picture would not change.

%\begin{solution}
%For (4a): if you were a point with coordinates $(a, b)$ not on the line, you would reflect to $(a, 10-b)$.\\
%For (4b): if you were a point with coordinates $(a, b)$ not on the line, you would reflect to $(-6-a , b)$.\\
%For (4e): if you were a point with coordinates $(a, b)$ not on the line, you would reflect to $(b, a)$.
%\end{solution}
%\end{problem}


%\begin{problem}
%Now say you are a member of the club described in number 4a and you want to rotate 90 degrees clockwise about the point (7, 5).  Where would you end up?  What if you were a member of the club described in number 4e and you wanted to rotate 90 degrees about the point (0, 0).  Where would you end up?

%\begin{solution}
%For (4a): the point $(a, 5)$ would end up at $(5, 14-a)$.\\
%For (4e): the point $(a,a)$ would end up at $(a, -a)$.
%\end{solution}
%\end{problem}
...
%\begin{problem}
%Rotate a triangle. Translate a circle.
%\end{problem}
