...
%COMMENTED OUT FOR MOVING TO ANOTHER ORDER
...
% \begin{problem}
% At home, cut out your figures in Activity 10R from the textbook activities manual. 
% \begin{itemize}
...
%     \item For participation credit, you'll submit your thinking for your own groupings -- so make sure to save it! %These should be posted to a discussion board or OneNote Collaboration space after class or at least AFTER playing the game below!
...
% As with triangles, there are special kinds of quadrilaterals:
% \[
% \includegraphics[width=4.75in]{graphics/defquads.pdf}
% \]
% \vskip 1in
% \begin{problem}
% Write two examples of ``possible or not possible'' questions (as in Problem 2 for triangles) using our special quadrilaterals.  One of your questions should be ``possible'', and the other should be ``not possible''. 
% \end{problem}
