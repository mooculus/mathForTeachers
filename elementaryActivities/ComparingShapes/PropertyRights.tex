...
{\bf Suggested timing:} We have two class periods to explore this activity. 

On the first day, you would like to get towards checking properties on at least two of the shapes either using the amplify activity or paper copies. There's quite a lot to do here, so you will want to give students about 20-25 minutes to explore. If students are working through the problems quickly, make sure that even if they are using a computer version that they are still measuring with rulers and protractors and trying to be exact about their arguments. Use the remaining part of the first class to discuss as much as you can.

On the second day, you can do one or two of the property checking questions, but your aim should be to make sure that students understand the difference between a definition and a property, and understand that properties can hold for some shapes or all shapes in a given category. You can focus on the question of generating examples that fit in the categories and don't fit in the categories, and using the categorization to explain how they know their answer is correct. Depending on what you have left over from the first day, you might give students 5-10 minutes to finish up checking properties, and discuss for about 15 minutes. Or, you could skip right to drawing new examples, giving students about 15 minutes to come up with examples and try to investigate Venn Diagrams. Leave significant time (20 minutes if possible) to discuss how they are checking properties and perhaps drawing these diagrams. If you need to cut this part short because you had leftovers from the previous day, give students 10 minutes to draw and leave 15 minutes to explain (and perhaps cut Venn Diagrams for now).

Wrap up with an overall discussion clarifying which properties are true for which shapes, what students could be expected to prove (using the Parallel Postulate), and what we can now assume (properties which require triangle congruence to prove).
