...
\begin{itemize}
	...
	\item The third day is for catch up and clean up. If the students are still struggling with any of the previous problems, go back to them and work as needed. If students are ready for a new challenge, you can start having them write their own story problems and solve them with a picture. Using improper fractions is usually a challenge at this stage!
\end{itemize}
