...
\begin{problem}
We had several different interpretations of subtraction.  Using our real-life integer contexts, try writing different types of story problems for each expression.
\end{problem}
...
\begin{itemize}
    ...
    \item Another item we pay attention to with these problems is which type of story students are writing.  As they are working with their stories and number lines, we may also ask, ``which type of story is this?'' to help students gain experience with identifying the structure.
