...
\end{itemize}
We will not ask students to distinguish between addition and subtraction with these structures (again following the text), as any of them could be used for either operation.  However, we will ask students to match a structure to a story situation, and to match their solving actions to the structure they have in mind. When there is no story or context, students' models should be a ``put together/take apart'' type, as this is our most basic meaning. Keep in mind that our students have usually not encountered the idea of structure very much prior to our course, so this can be a challenge! Furthermore, we need our prospective teachers to realize that when they teach, they should be ensuring that children see different problem types. Children don't naturally associate different problem types as all falling under the umbrella of ``addition'', and this is something the teacher will need to help children do.
