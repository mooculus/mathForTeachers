...
you write each question and your explanations, along with definitions 
and important concepts. In essence we want you to imagine that \textbf{we
...
\end{image}
%However, sometimes there may be a bug that prohibits a ``full green bar.''
%In that case, do not despair, as we take these bugs into account when
%grading. Moreover, 
Please \textbf{let us know} if you experience any issues at all. If possible 
\textbf{we will fix the issue}, and otherwise we will make adjustments.
