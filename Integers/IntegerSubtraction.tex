...
something means we should \wordChoice{\choice{add} \choice[correct]{subtract}} its value from 
...
we are adding, we face towards the \wordChoice{\choice{right} \choice[correct]{left}}.  We 
...
we are adding, we face towards the \wordChoice{\choice{right} \choice[correct]{left}}.  We will 
