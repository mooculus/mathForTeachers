...
are adding, we face towards the \wordChoice{\choice{right} \choice[correct]{left}}.  Now, we can think of the steps as our groups, meaning the amount we move with each step should be $\answer[given]{3}$ ticks \wordChoice{\choice{forward} \choice[correct]{backward}}, 
