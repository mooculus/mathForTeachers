...
\[
\includegraphics[width=2in]{graphics/FoliumOfDescartes.png} \qquad
\includegraphics[width=2in]{graphics/TridentOfNewton.png}
\]
\[
\includegraphics[width=2in]{graphics/WitchOfAgnesi.png} \qquad
\includegraphics[width=2in]{graphics/Bicorn.png}
\]
*Found to weigh the same as a duck \\
**Name to be changed (entering Witness Protection Program)\\
