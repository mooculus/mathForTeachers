...
Here is the net
\begin{image}
\includegraphics[angle=90,scale=0.7]{rightPyramid}
\end{image}
\end{teachingnote}
...
radius $r$.%\standardhs{G-GMD.1}\standardhs{G-GMD.2}   
\fixnote{Cite CCSS G-GMD.1,2.}
...
\begin{image}
\includegraphics[scale=1.1]{sphereVolume.pdf}
\end{image}
