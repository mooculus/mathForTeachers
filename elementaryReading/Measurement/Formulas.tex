...
If we are calculating the perimeter of a rectangle, perhaps you have seen the formula $P = 2l + 2w$ where $P$ is the \wordChoice{\choice{volume} \choice[correct]{perimeter} \choice{length} \choice{width}}, $l$ is the \wordChoice{\choice{volume} \choice{perimeter} \choice[correct]{length} \choice{width}}, and $w$ is the \wordChoice{\choice{volume} \choice{perimeter} \choice{length} \choice[correct]{width}} of our rectangle. But why is this formula true?
\begin{example}
