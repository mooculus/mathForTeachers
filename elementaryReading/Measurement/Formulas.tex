...
\section{Length}
The most common type of length formulas that we have are for calculating the perimeter of an object. For instance, we have a formula $C = \pi \times D$ or $C = 2 \pi r$ where $C$ is the \wordChoice{\choice[correct]{circumference} \choice{area} \choice{diameter} \choice{radius}}, $D$ is the \wordChoice{\choice{circumference} \choice{area} \choice[correct]{diameter} \choice{radius}} and $r$ is the \wordChoice{\choice{circumference} \choice{area} \choice{diameter} \choice[correct]{radius}} of a particular circle. We saw in the previous section that this is the definition of the number $\pi$, so we actually don't need to justify this formula.

If we are calculating the perimeter of a rectangle, perhaps you have seen the formula $P = 2l \times 2w$ where $P$ is the \wordChoice{\choice{volume} \choice[correct]{perimeter} \choice{length} \choice{width}}, $l$ is the \wordChoice{\choice{volume} \choice{perimeter} \choice[correct]{length} \choice{width}}, and $w$ is the \wordChoice{\choice{volume} \choice{perimeter} \choice{length} \choice[correct]{width}} of our rectangle. But why is this formula true?
\begin{example}
...
Mention parallelogram, trapezoid
...
V=Axh formula/box volume example

List other formulas

Wrap up about grade levels
