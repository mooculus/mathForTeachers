...
In the figure, the line $AB$ is a diameter of the circle because it passes through the circle's center, and the line $CD$ is not a diameter of the circle because it does not pass through the center. A line, like $CD$, which does not pass through the center of the circle is sometimes called a \dfn{chord} of the circle.
