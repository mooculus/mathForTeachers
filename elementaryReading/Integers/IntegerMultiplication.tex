...
are adding, we face towards the \wordChoice{\choice[correct]{right} \choice{left}}.  Now, we can think of the steps as our groups, meaning the amount we move with each step should be $\answer[given]{3}$ spaces \wordChoice{\choice{forward} \choice[correct]{backward}}, 
