...
Notice that the first number in our expression is Johnny's starting amount and the second number is the amount of the check. In future examples we might leave both numbers blank, so be sure to follow this pattern in terms of which number is entered first.
