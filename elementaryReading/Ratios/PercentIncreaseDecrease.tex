...
Next, we need to determine the whole for this problem. When we say that next year's class will be $45\%$ smaller than this year's class, we mean that we would like to calculate $45\%$ of this year's class and then remove these students from this year's class. In other words, the whole for this percent should be \wordChoice{\choice[correct]{this year's class} \choice{next year's class} \choice{$100$ students} \choice{Wafa's friends}}.
