...
\begin{definition}
A \dfn{transformation} takes a shape and moves it in some way. A special case of transformation is a \dfn{basic rigid motion} which takes a shape and moves it, but in a way that doesn't stretch or shrink the shape. 
\end{definition}
