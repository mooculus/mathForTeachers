...
When we work with triangles, we often designate one of its sides as the \dfn{base} of the triangle. We are usually most accustomed to seeing the bottom side labeled as the base, but any of the three sides of the triangle can be chosen as the base. Once we choose the segment called the base, we can also find a segment called the \dfn{height} of the triangle.
\begin{definition}
