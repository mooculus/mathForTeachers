...
\begin{definition}
We say that two shapes are \dfn{congruent} if we can find a sequence of transformations which are also basic rigid motions taking the first shape to the second shape.
\end{definition}
