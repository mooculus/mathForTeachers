...
\begin{center}
\begin{tikzpicture}
\node at (0,0) {\huge \textpmhg{{\HZi\HZi}}};
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}
\node at (0,0) {\huge \textpmhg{{\HZi\HZi\HZi\HZi\HZi\HZi\HZi\HZi\HZi}}};
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}
\node at (0,0) {\huge \textpmhg{\HVxx\HZi}};
\end{tikzpicture}
\end{center}
...
\begin{center}
\begin{tikzpicture}
\node at (0,0) {\huge \textpmhg{\HDl\HMxii\HMxii\HMxii\HZvii\HZvii\HZvii\HZvii\HVxx\HZi}};
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
\draw (0,0) circle (3pt) node[below]{$1$};
\draw (1,1) circle (3pt) node[below]{$1$};
\draw (1.2, -0.5) circle (3pt) node[below]{$1$};
\draw (1.5, 0.5) circle (3pt) node[below]{$1$};
\draw (2, 0.3) circle (3pt) node[below]{$1$};
\end{tikzpicture}
\end{center}
...
- tens vs tenths (maybe in decimals)
