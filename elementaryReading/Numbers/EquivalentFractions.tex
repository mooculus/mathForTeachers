...
\link[More with fractions]{https://ximera.osu.edu/m4t/elementaryActivities/SemesterOnePacket/elementaryActivities/Numbers/MoreWithFractions}, 
\link[A marketing meeting]{https://ximera.osu.edu/m4t/elementaryActivities/SemesterOnePacket/elementaryActivities/Numbers/MarketingMeeting}
...
But we could also divide the cup of sugar into, say, three equal pieces without changing the whole or changing the shaded part. Let's re-draw the same picture, but with additional divisions.
...
Our definition of equivalent fractions says that we need to keep the same whole and the same shaded part, but that we can change how those are cut. So, let's cut each of our shaded pieces into two equal pieces. We'll used dashed lines to see these new cuts in our original picture.
